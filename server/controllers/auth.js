...
var AuthController = /** @class */ (function () {
    ...
    AuthController.login = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var _b, email, password, user, token, isCorrectPassword;
        return __generator(_a, function (_c) {
            switch (_c.label) {
                case 0:
                ...
                case 1:
                    ...
                    return [4 /*yield*/, user_1.default.findOne({ name: email }).select('+password')];
                case 2:
                    user = _c.sent();
                    if (!user) {
    ...
    AuthController.update = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        return __generator(_a, function (_b) {
            res.send('update user');
            return [2 /*return*/];
        });
    }); };
    AuthController.getUser = function (req, res) { return __awaiter(void 0, void 0, void 0, function () {
        var id, user, userStats;
        return __generator(_a, function (_b) {
            switch (_b.label) {
                case 0:
                    id = req.query.id;
                    return [4 /*yield*/, user_1.default.findOne({ id: id }).select('+password')];
                case 1:
                    user = _b.sent();
